    ...
    return (
        ...
        <div className="relative font-saman w-full overflow-hidden bg-[#F0EAD6] h-auto py-8 lg:h-screen lg:py-0">
            ...
            <div className="relative z-10 flex h-full  flex-col items-center justify-center space-y-2 md:space-y-4">
                ...
                <h2 className="text-5xl md:text-7xl md:pt-20 sm:-mt-20 xl:text-8xl xl:pt-16 font-light text-[#980204] font-samarkan tracking-wide drop-shadow-[4px_4px_0px_rgba(246,164,64,1)]">
                    gallery
                </h2>

          
                <div className="flex w-full">
                    <Marquee pauseOnHover={true} speed={109} className="overflow-y-visible py-6 md:py-16">
